...
What you can do with Sketch Toolbox:

1. **Browse the most popular plugins available for Sketch**
...
2. **Download and install new plugins with a single click**
	- No more downloading and moving plugin files around within your app directories. One-click-install and you're done
3. **Automatically keep all your plugins up to date**
	- Being connected to a plugin's GitHub repo means that Sketch Toolbox can simply download the latest source code and keep you up to date

After you've got Sketch Toolbox installed, you'll be rolling with plugins in no time. 
